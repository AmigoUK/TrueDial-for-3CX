...
| 3   | Engineering hygiene: GitHub Actions CI (typecheck, tests, build), ESLint + Prettier, extension icons, README/CHANGELOG refresh, complete the British English convention (UI strings, demo page, test descriptions) | P1       | 1–2 d    | done   |
...
| 8   | Live 3CX V20 verification protocol (manual test script; release 1.0.0 is gated on it)                                                                                                                              | P1 gate  | 0.5 d    | done   |
